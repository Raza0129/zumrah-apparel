...
import {
  Star, Heart, ShoppingBag, Sparkles, Share2,
  Truck, Package, Shield, RotateCcw, Check, BadgeCheck,
} from "lucide-react";
import { useCartStore } from "@/store/cart";
import { toggleWishlistAction } from "@/lib/actions/wishlist";
import { formatPKR } from "@/lib/shipping";
import type { ProductDetailData, ProductCardData } from "@/lib/types";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <h1 className="text-white text-3xl font-bold mb-3 font-sans">{product.name}</h1>
            ...
            <div className="mb-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[#D4AF37] text-sm">{selectedColor?.name}</span>
              </div>
              <div className="flex flex-wrap gap-2.5">
                {product.colors.map((color) => (
                  <button
                    ...
                    className={`w-9 h-9 rounded-full border-2 transition-all hover:scale-110 ${selectedColor?.hex === color.hex ? "border-[#D4AF37] scale-110 shadow-[0_0_10px_rgba(212,175,55,0.5)]" : "border-[#333]"}`}
            ...
            <div className="mb-6">
              <span className="text-white text-sm font-semibold block mb-3">Size</span>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-3 bg-[#111] border border-[#333] rounded-xl">
                ...
                <button onClick={() => setQuantity((q) => q + 1)} className="w-10 h-10 flex items-center justify-center text-gray-400 hover:text-white transition-colors">+</button>
              </div>
            ...
            <div className="bg-[#111] border border-[#1e1e1e] rounded-2xl p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-gray-300">Cash on Delivery available nationwide</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            {activeTab === "description" && (
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Every Zumrah Apparel product is crafted with premium materials and subjected to rigorous quality control.
                </p>
              </div>
            )}
            {activeTab === "features" && (
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-500 text-xs">{new Date(review.createdAt).toLocaleDateString("en-PK", { year: "numeric", month: "long", day: "numeric" })}</p>
                            </div>
                          </div>
