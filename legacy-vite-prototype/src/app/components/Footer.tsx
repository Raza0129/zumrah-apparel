...
import { Shirt, Instagram, Facebook, Twitter, Youtube, Mail, Phone, MapPin, ArrowRight } from "lucide-react";
      ...
      <div className="bg-gradient-to-r from-[#D4AF37]/10 via-[#D4AF37]/5 to-[#D4AF37]/10 border-b border-[#D4AF37]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-white text-xl font-semibold mb-1" style={{ fontFamily: "Poppins, sans-serif" }}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["DTF Printing", "Sublimation Printing", "Custom T-Shirts", "Sports Jerseys", "Polo Shirts", "Hoodies", "Corporate Uniforms", "Bulk Orders"].map((item) => (
                <li key={item}>
                  <Link to="/shop" className="text-gray-400 hover:text-[#D4AF37] text-sm transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Design Studio", "3D Customizer", "Design Templates", "File Upload", "Bulk Ordering", "Brand Merchandise", "University Gear", "Sports Kits"].map((item) => (
                <li key={item}>
                  <Link to="/designer" className="text-gray-400 hover:text-[#D4AF37] text-sm transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-gray-500 text-sm">
              © 2026 Zumrah Apparel. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              ...
              {["VISA", "MC", "EP", "JC", "COD"].map((method) => (
                <span
                  key={method}
                  className="px-2 py-1 bg-[#1a1a1a] border border-[#333] rounded text-xs text-gray-400 font-medium"
                >
                  {method}
                </span>
              ))}
